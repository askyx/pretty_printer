...
NestPath = [
  ...
  ('Distribution*', 'jpath.path.distribution'),
...
PlannedStmt = [
  ...
  ('int', 'nParamExec'),
  ('int', 'nParamRemote'),
  ('struct RemoteParam*', 'remoteparams'),
  ('const char*', 'pname'),
