...
RemoteQuery = [
  ...
  ('char*', 'cursor'),
  ('int', 'rq_num_params'),
  ('Oid[rq_num_params]', 'rq_param_types'),
  ('bool', 'rq_params_internal'),
  ('RemoteQueryExecType', 'exec_type'),
  ('bool', 'is_temp'),
  ('bool', 'rq_finalise_aggs'),
  ('bool', 'rq_sortgroup_colno'),
  ('Query*', 'remote_query'),
  ('List*', 'base_tlist'),
  ('List*', 'coord_var_tlist'),
  ('List*', 'query_var_tlist'),
  ('bool', 'has_row_marks'),
  ('bool', 'rq_save_command_id'),
  ('bool', 'rq_use_pk_for_rep_change'),
  ('int', 'rq_max_param_num')
]
