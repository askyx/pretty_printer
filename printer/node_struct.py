...
Path = [
  ...
  ('CdbLocusType', 'locus.locustype'),
  ('List*', 'locus.distkey'),
  ('int', 'locus.numsegments'),
  ('bool', 'motionHazard'),
  ('bool', 'rescannable'),
  ('List*', 'pathkeys'),
...
IndexPath = [
  ...
  ('EstimatedBytes', 'path.memory'),
  ('CdbLocusType', 'path.locus.locustype'),
  ('List*', 'path.locus.distkey'),
  ('int', 'path.locus.numsegments'),
  ('bool', 'path.motionHazard'),
  ('bool', 'path.rescannable'),
  ('List*', 'path.pathkeys'),
  ('Relids', 'path.sameslice_relids'),
...
NestPath = [
  ...
  ('EstimatedBytes', 'jpath.path.memory'),
  ('CdbLocusType', 'jpath.path.locus.locustype'),
  ('List*', 'jpath.path.locus.distkey'),
  ('int', 'jpath.path.locus.numsegments'),
  ('bool', 'jpath.path.motionHazard'),
  ('bool', 'jpath.path.rescannable'),
  ('List*', 'jpath.path.pathkeys'),
  ('Relids', 'jpath.path.sameslice_relids'),
...
IncrementalSortPath = [
  ...
  ('EstimatedBytes', 'spath.path.memory'),
  ('CdbLocusType', 'spath.path.locus.locustype'),
  ('List*', 'spath.path.locus.distkey'),
  ('int', 'spath.path.locus.numsegments'),
  ('bool', 'spath.path.motionHazard'),
  ('bool', 'spath.path.rescannable'),
  ('List*', 'spath.path.pathkeys'),
  ('Relids', 'spath.path.sameslice_relids'),
  ('Path*', 'spath.subpath'),
  ('int', 'nPresortedCols'),
]
...
SeqScan = [
  ...
  ('Flow*', 'scan.plan.flow'),
  ('uint64', 'scan.plan.operatorMemKB'),
...
NestLoop = [
  ...
  ('Flow*', 'join.plan.flow'),
  ('uint64', 'join.plan.operatorMemKB'),
...
IncrementalSort = [
  ...
  ('Flow*', 'sort.plan.flow'),
  ('uint64', 'sort.plan.operatorMemKB'),
  ('int', 'sort.numCols'),
...
GpPolicy = [
  ...
  ('int', 'numsegments'),
  ('int', 'nattrs'),
  ('AttrNumber[nattrs]', 'attrs'),
  ('Oid[nattrs]', 'opclasses'),
]
...
PlanSlice = [
  ...
  ('int', 'numsegments'),
  ('int', 'segindex'),
  ('bool', 'directDispatch.isDirectDispatch'),
  ('List*', 'directDispatch.contentIds'),
  ('bool', 'directDispatch.haveProcessedAnyCalculations'),
]
...
Motion = [
  ...
  ('int', 'motionID'),
  ('List*', 'hashExprs'),
  ('Oid[list_length(hashExprs)]', 'hashFuncs'),
  ('int', 'numHashSegments'),
  ('AttrNumber', 'segidColIdx'),
  ('int', 'numSortCols'),
  ('AttrNumber[numSortCols]', 'sortColIdx'),
  ('Oid[numSortCols]', 'sortOperators'),
  ('Oid[numSortCols]', 'collations'),
  ('bool[numSortCols]', 'nullsFirst'),
...
SplitUpdate = [
  ...
  ('List*', 'deleteColIdx'),
  ('int', 'numHashAttrs'),
  ('AttrNumber[numHashAttrs]', 'hashAttnos'),
  ('Oid[numHashAttrs]', 'hashFuncs'),
  ('int', 'numHashSegments'),
]
